@php
    ...
    $pageRouteMap = [
        ...
        'monitors' => \App\Filament\Dashboard\Resources\SiteResource\Pages\Monitors::class,
        ...
        'tests' => \App\Filament\Dashboard\Resources\SiteResource\Pages\Tests::class,
        'repositories' => \App\Filament\Dashboard\Resources\SiteResource\Pages\Repositories::class,
        'repos' => \App\Filament\Dashboard\Resources\SiteResource\Pages\Git::class,
        ...
        'blacklists' => \App\Filament\Dashboard\Resources\SiteResource\Pages\Blacklists::class,
    ...
    $groups = [
        ...
        [
            ...
            'items' => array_filter([
                ...
                $canGit ? ['label' => 'Git Deploy', 'route' => 'repos'] : null,
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Blacklists', 'route' => 'blacklists'],
