...
<div class="flex items-center">
    <div class="rounded-full py-1 px-2 inline-flex items-center gap-2">
    <p class="text-gray-600 dark:text-gray-200 text-sm">
        <strong>{{ $getRecord()->php_ver ?? '' }}</strong>
    </p>
    </div>

    {{-- <div class="rounded-full {{ \App\Services\Helpers\BladeHelper::getPHPBackgroundClass( $getRecord()->php_ver ?? null ) }} py-1 px-2 inline-flex items-center gap-2">
