...
<x-filament::tabs.item 
    ...
    :active="request()->getRequestUri() === \URL::route('filament.dashboard.resources.sites.insights', ['record' => $this->getRecord()->id ? $this->getRecord()->id : '2', 'tenant' => $tenant->uuid], false)"
>
    AI Insights  
</x-filament::tabs.item>
@endif
